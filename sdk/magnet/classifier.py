...
class ContextClassifier:
    ...
    """
    CONTEXTS = {
        "coding": ["python", "code", "function", "error", "bug", "html", "css", "javascript", "sql", "algorithm", "software"],
        "business_strategy": ["strategy", "marketing", "sales", "growth", "analysis", "competitor", "company", "investment", "finance", "market"],
        "writing": ["writing", "article", "blog", "story", "poem", "text", "tone", "creative", "draft", "book", "content"],
        "learning": ["what is", "how to", "explain", "learn", "education", "concept", "example", "guide", "difference", "history", "tell"]
    }

    @classmethod
    def detect(cls, text: str) -> str:
        """Detects the most likely context from the text."""
        if not text:
            return "general_chat"
            
        text = text.lower()
        scores = {ctx: 0 for ctx in cls.CONTEXTS}
